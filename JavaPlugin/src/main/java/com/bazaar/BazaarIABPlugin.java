...
public class BazaarIABPlugin extends BazaarIABPluginBase
    ...
    public void init(String publicKey) {
        ...
        try {
            ...
            mHelper.enableDebugLogging(IABLogger.DEBUG);
    ...
    /***
     *
     * @return version code else -1
     */
    public long getLatestVersionInMarket() {
        if (mHelper != null)
            return mHelper.getLatestVersionCodeInMarket();
        return -1;
    }

    /**
     * @return current version code else -1
     */
    ...
    /**
     * @return current version name else null
     */
